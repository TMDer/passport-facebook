...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://www.facebook.com/v2.3/dialog/oauth';
  ...
  this._profileURL = options.profileURL || 'https://graph.facebook.com/v2.3/me';
